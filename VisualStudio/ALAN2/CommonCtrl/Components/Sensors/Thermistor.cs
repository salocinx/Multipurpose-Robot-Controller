...
namespace CommonCtrl {
    ...
    [Serializable]
    public class Thermistor : Sensor, iLogbook {
        ...
        public override void update(Component component) {
            if(GetType() == component.GetType()) {
                Thermistor c = (Thermistor)component;
                #region Change Pin
                if(c.Pin!=pin) {
