...
namespace RemoteCtrl {
    ...
    public partial class InfraredRxConfigWindow : Form {

        #region Fields
        private Agent agent;
        private InfraredRx infrared;
        #endregion

        #region Lifecycle
        public InfraredRxConfigWindow(Agent agent, InfraredRx infrared) {
            this.agent = agent;
        ...
        private void InfraredRxConfigWindow_FormClosing(object sender, FormClosingEventArgs evt) {
